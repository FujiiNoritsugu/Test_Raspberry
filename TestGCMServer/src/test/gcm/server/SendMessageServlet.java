...
public class SendMessageServlet extends BaseServlet {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (regId != null) {
        ...
        if(angle != null){
      	  builder = builder.addData("angle", angle);
        }

        if(piston != null){
          builder = builder.addData("piston", piston);
        }

      sendSingleMessage(regId, resp, builder);
      return;
    }
  ...
  private void sendSingleMessage(String regId, HttpServletResponse resp, Builder builder) {
